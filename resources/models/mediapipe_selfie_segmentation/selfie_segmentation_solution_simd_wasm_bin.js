var createMediapipeSolutionsWasm = (() => {
  ...
  return function (createMediapipeSolutionsWasm) {
    ...
    assert(
      ...
      'INITIAL_MEMORY should be larger than STACK_SIZE, was ' + INITIAL_MEMORY + '! (STACK_SIZE=' + STACK_SIZE + ')'
    );
    assert(
    ...
    var wasmBinaryFile;
    wasmBinaryFile = 'selfie_segmentation_solution_simd_wasm_bin.wasm';
        ...
        if (init_once) {
          ...
          findCanvasEventTarget = function (target) {
            if (target == 0) {
              ...
              if (typeof console !== 'undefined') {
                console.warn(
                  'Module properties canvas and canvasCssSelector not ' + 'found during WebGL context creation.'
                );
              }
            }
    ...
    var ___start_em_js = (Module['___start_em_js'] = 514739);
    var ___stop_em_js = (Module['___stop_em_js'] = 515259);
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = createMediapipeSolutionsWasm;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return createMediapipeSolutionsWasm;
  });
else if (typeof exports === 'object') exports['createMediapipeSolutionsWasm'] = createMediapipeSolutionsWasm;
